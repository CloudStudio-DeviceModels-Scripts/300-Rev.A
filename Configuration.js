...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
    ...
    var e = endpoints.addEndpoint("1", "Traffic light 1", endpointType.genericSensor);
    e.variableTypeId = 1052;
    var e = endpoints.addEndpoint("2", "Traffic light 2", endpointType.genericSensor);
    e.variableTypeId = 1052;

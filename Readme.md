...
# Configuration Script – 300 - Rev. A

This **Configuration** script is designed for the **300** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – 300 Rev. A

Este script de **Configuration** está diseñado para el modelo **300** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
